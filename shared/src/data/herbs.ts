...
export const HERBS: Herb[] = [
  ...
  { id: 'ebolo', yoruba: 'Ebolo', otherNames: ['Yoruban bologi'], english: 'Ebolo', botanical: 'Crassocephalum crepidioides', part: 'Leaf', category: 'leafy_herbs', traditionalUse: 'Traditional leafy vegetable.', platformClass: 'A', regulatoryFlag: 'amber', note: 'Contains pyrrolizidine alkaloids (e.g. jacobine) — dried/tea/supplement forms need a PA limit-test certificate. PENDING UK regulatory adviser confirmation.' },
  ...
  { id: 'rere', yoruba: 'Rere', otherNames: ['Abo rere', 'Coffee senna'], english: 'Coffee senna', botanical: 'Senna occidentalis', part: 'Leaf/seed', category: 'leafy_herbs', traditionalUse: 'Traditional bitter decoction leaf.', platformClass: 'D', regulatoryFlag: 'red', note: 'Seeds are toxic (fatal hepatotoxicity reported in children); senna laxatives are UK licensed medicines. Blocked pending UK regulatory adviser — a leaf-only culinary listing may be re-enabled by admin.' },
  ...
  { id: 'obi', yoruba: 'Obi', otherNames: ['Kola nut', 'Oji'], english: 'Kola nut', botanical: 'Cola acuminata', part: 'Seed', category: 'fruits_kola', traditionalUse: 'Stimulant nut, central to hospitality and ceremony.', platformClass: 'A', regulatoryFlag: 'amber', note: 'Caffeine source — high-caffeine labelling required; no stimulant/energy health claims. PENDING UK regulatory adviser confirmation.' },
  ...
  // ── From "Yoruba Medicinal Leaves and Names" (community compilation, scribd.com/
  // document/506090256) — a dense unverified personal list of ~200+ names across 8
  // pages, most of it paywalled and not reviewed here. Only these 5 were added, each
  // cross-checked against general botanical knowledge before inclusion; the "afomo"
  // entry corrects a scientific-name pairing that looked mis-transcribed in the
  // source. The rest of that document is a flagged candidate for a future pass, not
  // yet verified — do not treat it as a source of truth on its own.
  { id: 'ado-ato', yoruba: 'Ado / Ato', otherNames: ['Bottle gourd'], english: 'Bottle gourd', botanical: 'Lagenaria siceraria', part: 'Fruit', category: 'fruits_kola', traditionalUse: 'Hard-shelled gourd; dried shells traditionally used as containers, flesh sometimes eaten young.', platformClass: 'A', regulatoryFlag: 'green' },
  { id: 'adodo', yoruba: 'Adodo', otherNames: [], english: 'Desmodium', botanical: 'Desmodium spp. (e.g. D. adscendens)', part: 'Leaf/whole plant', category: 'leafy_herbs', traditionalUse: 'Leaf traditionally used in decoctions associated with the chest and liver.', platformClass: 'D', regulatoryFlag: 'amber', note: 'Genus commonly tied to respiratory/liver medicinal claims — review; no disease claims permitted.' },
  { id: 'afon', yoruba: 'Afon', otherNames: ['Oyinbo tree'], english: 'Chinaberry / Persian lilac', botanical: 'Melia azedarach', part: 'Leaf/fruit', category: 'barks_stems', traditionalUse: 'Leaves used traditionally as an insect repellent; shade tree.', platformClass: 'D', regulatoryFlag: 'red', note: 'Fruit/seeds are documented as toxic if ingested — not listable as an ingestible product.' },
  { id: 'afomo', yoruba: 'Afomo', otherNames: ['African mistletoe'], english: 'African mistletoe', botanical: 'Tapinanthus bangwensis', part: 'Leaf/stem', category: 'leafy_herbs', traditionalUse: 'Parasitic plant used in traditional decoctions.', platformClass: 'D', regulatoryFlag: 'amber', note: 'Common folk claims around blood pressure/diabetes; composition varies by host tree — review required, no disease claims permitted. (Source doc paired this with an apparently mis-transcribed scientific name; corrected here from general botanical references.)' },
  { id: 'abura', yoruba: 'Abura', otherNames: [], english: 'Abura', botanical: 'Mitragyna stipulosa', part: 'Bark', category: 'barks_stems', traditionalUse: 'Bark used in traditional decoctions; also a timber species.', platformClass: 'D', regulatoryFlag: 'amber', note: 'Same genus as kratom (Mitragyna speciosa, a different species) — review before listing.' },

  // ── From tewetegbo.com/agbo-yoruba-herbal-mixture-formula (docs/herbs-catalog.md
  // §8) — named as functional roles within a traditional agbo formula, not a
  // standalone consumer product. Included so the compliance/search engine recognises
  // them when a seller names them; not endorsements of the traditional-medicine use.
  { id: 'ipeta', yoruba: 'Ipeta', otherNames: ['Violet tree', 'Fibre bush'], english: 'Violet tree', botanical: 'Securidaca longipedunculata', part: 'Root/bark', category: 'roots_rhizomes', traditionalUse: "Described as the traditional \"center\" (coordinating) herb of many agbo formulas.", platformClass: 'D', regulatoryFlag: 'red', note: 'Root/bark preparations are documented in the literature as potentially toxic depending on part and dose — not listable as an ingestible product pending adviser review.' },
